...
interface AnimationModulePreface {
	SyncPlayer(MethodTable: object): object; //Gives the script access to the players current animate script instance//
...
AnimationModule.SyncPlayer = function (MethodTable: object | undefined) {
	...
	return AnimationLibrary.AnimationPacks.Default;
};
